...
if(!exists("NEI")){
  ...
  NEI <- readRDS("F:/TECHNOLOGY/Coursera/R/exdata_data_NEI_data/summarySCC_PM25.rds")
  
}

if(!exists("SCC")){
  
  SCC <- readRDS("F:/TECHNOLOGY/Coursera/R/exdata_data_NEI_data/Source_Classification_Code.rds")
